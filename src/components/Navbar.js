    ...
    <nav className="bg-black py-4">
      <div className="container mx-auto flex justify-between items-center px-4 xl:px-0">
        ...
        <a href="/" className="flex items-center">
          <img src="https://i.ibb.co/LZ9zp1N/200-X200-MEOW.png" alt="WOOF Logo" className="h-12" />
        </a>
        <div className="flex items-center">
          {/* Social Icons */}
          <a href="https://twitter.com/meowsoltoken" target="_blank" rel="noopener noreferrer" className="text-white px-3">
          ...
          <a href="https://t.me/meowsolcommunity" target="_blank" rel="noopener noreferrer" className="text-white px-3">
